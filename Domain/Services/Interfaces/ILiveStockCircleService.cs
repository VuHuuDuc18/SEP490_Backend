...
namespace Domain.Services.Interfaces
{
    public interface ILivestockCircleService
    {
        ...
        /// </summary>
        Task<(LivestockCircleResponse Circle, string ErrorMessage)> GetByIdAsync(
            Guid id, 
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<(List<LivestockCircleResponse> Circles, string ErrorMessage)> GetAllAsync(
            string status = null, 
            Guid? barnId = null, 
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<(List<LivestockCircleResponse> Circles, string ErrorMessage)> GetByTechnicalStaffAsync(
        ...
        /// </summary>
        Task<(bool Success, string ErrorMessage)> UpdateAverageWeightAsync(
            Guid id,
            float averageWeight,
            CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<(bool Success, string ErrorMessage)> ChangeStatusAsync(
            Guid id,
            string status,
            CancellationToken cancellationToken = default);
