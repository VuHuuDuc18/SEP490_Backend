...
namespace Domain.IServices
{
    public interface IBillService
    {
        ...
        Task<(PaginationSet<BillResponse> Result, string ErrorMessage)> GetPaginatedBillListHistory(ListingRequest request, string billType, CancellationToken cancellationToken = default);
        ...
        public Task<(PaginationSet<BillResponse> Result, string ErrorMessage)> GetApprovedBillsByWorker(ListingRequest request, CancellationToken cancellationToken = default);
        public Task<(PaginationSet<BillResponse> Result, string ErrorMessage)> GetHistoryBillsByWorker(ListingRequest request, CancellationToken cancellationToken = default);

        Task<(PaginationSet<BillResponse> Result, string ErrorMessage)> GetPaginatedBillListByTechicalStaff(ListingRequest request, string billType, CancellationToken cancellationToken = default);
